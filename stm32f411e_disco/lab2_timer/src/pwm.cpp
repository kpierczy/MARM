 ...
 *        Core : stm32f411vet
 *
 * Description : Programm drives LED3-LED6 diodes using PWM signal generated by
 *               the TIM4 timer/counter. Duty cycles are set to:
 *          
 *                  (LED4) : 20 %
 *                  (LED3) : 40 %
 *                  (LED5) : 60 %
 *                  (LED6) : 0 - 100 %
 * 
 *               Brightness of the LED6 can be addjusted with a USER button
 *               (debounced by software) with a step of 10% size. When duty 
 *               cycle reaches 100% , subsequent triggers will decrease duty
 *               cycle by 10%.
 *  
 *               Once per second information about TIM4 crucial registers is sent
 *               to the serial debug port (USART2).
 * 
 *===============================================================================*/
